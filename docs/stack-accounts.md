...
These accounts are required for PrestaShop image installation and configuration

## PrestaShop

Administrator account is set by yourselft at the time of PrestaShop installation wizard
